...
class TestAdminViews:
    def setup_method(self):
        ...
        Law.objects.create(official_id='law-1', name='Federal Law', tier='0', category='ley')
        Law.objects.create(official_id='law-2', name='State Law', tier='1', category='codigo')
        Law.objects.create(official_id='law-3', name='Muni Law', tier='2', category='reglamento')
