export default function LawsLoading() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 to-stone-100 dark:from-gray-900 dark:to-stone-950">
      {/* Header skeleton */}
      <div className="bg-gradient-to-r from-crimson-600 to-crimson-800 text-white shadow-xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border-l-4 border-muted animate-pulse">
