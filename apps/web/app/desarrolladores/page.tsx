  ...
  es: {
    ...
    endpoints: {
      ...
      items: [
        ...
        { method: 'GET', path: '/api/v1/user/export/', desc: 'Exportar todos tus datos de cuenta (contrato tezca-egress/v1). Requiere autenticación; solo devuelve tus propios datos. No incluye el corpus legal público.' },
        { method: 'GET', path: '/api/v1/user/export/download/', desc: 'Lo mismo, descargado como archivo JSON.' },
  ...
  en: {
    ...
    endpoints: {
      ...
      items: [
        ...
        { method: 'GET', path: '/api/v1/user/export/', desc: 'Export all of your account data (tezca-egress/v1 contract). Authenticated; returns only your own data. Excludes the public law corpus.' },
        { method: 'GET', path: '/api/v1/user/export/download/', desc: 'The same envelope, delivered as a JSON file download.' },
  ...
  nah: {
    ...
    endpoints: {
      ...
      items: [
        ...
        { method: 'GET', path: '/api/v1/user/export/', desc: 'Exportar mochi motlahtōl (tezca-egress/v1).' },
        { method: 'GET', path: '/api/v1/user/export/download/', desc: 'Yeh, quēmeh JSON tlahcuilōlli.' },
