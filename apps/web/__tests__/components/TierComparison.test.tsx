...
describe('TierComparison', () => {
    ...
    it('renders full mode with feature comparison table (desktop)', () => {
        ...
        // Verify all 8 feature rows exist in the desktop table.
        ...
        expect(screen.getAllByText('Descargar PDF').length).toBeGreaterThanOrEqual(1);
    ...
    it('shows "Gratis" badge for essentials tier', () => {
        render(<TierComparison />);
    ...
    it('shows "Popular" badge for community tier', () => {
        render(<TierComparison />);
