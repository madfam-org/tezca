...
export default function ComparisonFloatingBar() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 z-50 shadow-lg animate-in slide-in-from-bottom overflow-hidden">
